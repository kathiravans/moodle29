...
if(!in_array($USER->id,$siteadmins)){ // kathir portal // redirecting to course category page only if user is a student
    $courses = enrol_get_my_courses();
    foreach($courses as $course) {
        $categoryid = $course->category;
    }
    redirect("$CFG->wwwroot/course/index.php?categoryid=$categoryid");
}
