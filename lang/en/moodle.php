...
$string['addnewcategory'] = 'Add new institution';
$string['addnewcourse'] = 'Add a new study group';
...
$string['addsubcategory'] = 'Add a subinstitution';
...
$string['adminhelpassigncreators'] = 'Course creators can create new study group';
...
$string['adminhelpcourses'] = 'Define study groups and categories and assign people to them, edit pending courses';
...
$string['administratordescription'] = 'Administrators can usually do anything on the site, in all study groups.';
...
$string['availablecourses'] = 'Available study groups';
$string['back'] = 'Back';
...
$string['backupfailed'] = 'Some of your study groups weren\'t saved!!';
...
$string['bulkmovecoursessuccess'] = 'Successfully moved {$a->courses} study groups into {$a->category}';
...
$string['categories'] = 'Hangouts';
$string['categoriesandcoures'] = 'Course Institutions and study groups';
$string['category'] = 'Institution';
$string['categoryadded'] = 'The institution \'{$a}\' was added';
$string['categorybulkaction'] = 'Bulk actions for selected institutions';
$string['categorycontents'] = 'Subcategories and study groups';
$string['categorycurrentcontents'] = 'Contents of {$a}';
$string['categorydeleted'] = 'The institution \'{$a}\' was deleted';
$string['categoryduplicate'] = 'A institution named \'{$a}\' already exists!';
$string['categorymodifiedcancel'] = 'Institution was modified! Please cancel and try again.';
$string['categoryname'] = 'Institution name';
$string['categorysubcategoryof'] = '{$a->category} - subinstitution of {$a->parentcategory}';
$string['idnumbercoursecategory'] = 'Institution ID number';
$string['idnumbercoursecategory_help'] = 'The ID number of a course institution  is only used when matching the institution against external systems and is not displayed anywhere on the site. If the category has an official code name it may be entered, otherwise the field can be left blank.';
$string['categoryupdated'] = 'The institution \'{$a}\' was updated';
...
$string['coursebulkaction'] = 'Bulk actions for selected study groups';
$string['coursecategories'] = 'Course categories';
$string['coursecategory'] = 'Course category';
$string['coursecategory_help'] = 'This setting determines the category in which the course will appear in the list of study groups.';
...
$string['coursecreatorsdescription'] = 'Course creators can create new study groups.';
...
$string['courseoverviewfiles_help'] = 'Course summary files, such as images, are displayed in the list of study groups together with the summary.';
...
$string['courses'] = 'Study groups';
$string['coursesectionsummaries'] = 'study group section summaries';
$string['coursesectiontitle'] = 'Study group: {$a->course}, {$a->sectionname}: {$a->sectiontitle}';
$string['coursesettings'] = 'Course default settings';
$string['coursesmovedout'] = 'Study groups moved out from {$a}';
$string['coursespending'] = 'Study groups pending approval';
$string['coursestart'] = 'Study group start';
$string['coursesummary'] = 'Study group summary';
$string['coursesummary_help'] = 'The course summary is displayed in the list of study groups. A course search searches course summary text in addition to course names.';
$string['coursetitle'] = 'Study group: {$a->course}';
$string['courseupdates'] = 'Study group updates';
$string['create'] = 'Create';
$string['createaccount'] = 'Create my new account';
$string['createcategory'] = 'Create institution';
$string['createfolder'] = 'Create a folder in {$a}';
$string['createnew'] = 'Create new';
$string['createnewcategory'] = 'Create new institution';
$string['createnewcourse'] = 'Create new study group';
$string['createnewsubcategory'] = 'Create new subinstitution';
$string['createsubcategoryof'] = 'Create subinstitution of {$a}';
...
$string['creatingnewcourse'] = 'Creating new study group';
...
$string['deletecategory'] = 'Delete institution: {$a}';
$string['deletecategoryempty'] = 'This institution is empty.';
$string['deletecategorycheck'] = 'Are you absolutely sure you want to completely delete this institution <b>\'{$a}\'</b>?<br />This will move all courses into the parent category if there is one, or into Miscellaneous.';
$string['deletecategorycheck2'] = 'If you delete this institution, you need to choose what to do with the courses and subcategories it contains.';
...
$string['edit'] = 'Edit';
$string['edita'] = 'Edit {$a}';
$string['editcategorysettings'] = 'Edit institution settings';
$string['editcategorythis'] = 'Edit this institution';
$string['editcoursesettings'] = 'Edit study group settings';
...
$string['eventcoursecategorycreated'] = 'Institution created';
$string['eventcoursecategorydeleted'] = 'Institution deleted';
$string['eventcoursecategoryupdated'] = 'Institution updated';
$string['eventcoursecontentdeleted'] = 'Study group content deleted';
$string['eventcoursecreated'] = 'Study group created';
$string['eventcoursedeleted'] = 'Study group deleted';
$string['eventcoursemodulecreated'] = 'Study group module created';
$string['eventcoursemoduledeleted'] = 'Study group module deleted';
$string['eventcoursemoduleupdated'] = 'Study group module updated';
$string['eventcoursemoduleviewed'] = 'Study group module viewed';
$string['eventcourseresetended'] = 'Study group reset ended';
$string['eventcourseresetstarted'] = 'Study group reset started';
$string['eventcourserestored'] = 'Study group restored';
$string['eventcourseupdated'] = 'Study group updated';
$string['eventcoursesectionupdated'] = 'Study group section updated';
$string['eventcoursemoduleinstancelistviewed'] = 'Study group module instance list viewed';
$string['eventcourseuserreportviewed'] = 'Study group user report viewed';
$string['eventcourseviewed'] = 'Study group viewed';
...
$string['findmorecourses'] = 'Find more study groups...';
$string['first'] = 'First';
...
$string['frontpagecategorynames'] = 'List of institution';
$string['frontpagecourselist'] = 'List of courses';
$string['frontpagecoursesearch'] = 'Course search box';
$string['frontpageenrolledcourselist'] = 'Enrolled Study groups';
...
$string['fulllistofcourses'] = 'All study groups';
...
$string['fullnamecourse_help'] = 'The full name of the course is displayed at the top of each page in the course and in the list of Study groups.';
...
$string['childcourses'] = 'Child study groups';
...
$string['listofcourses'] = 'List of study groups';
...
$string['managecategorythis'] = 'Manage this Institution';
$string['managecourses'] = 'Manage study groups';
...
$string['maxnumcoursesincombo'] = 'Browse <a href="{$a->link}">{$a->numberofcourses} study groups</a>.';
...
$string['missingcategory'] = 'You need to choose a institution';
...
$string['movecategorysuccess'] = 'Successfully moved institution \'{$a->moved}\' into institution \'{$a->to}\'';
$string['movecategoriessuccess'] = 'Successfully moved {$a->count} categories into institution \'{$a->to}\'';
$string['movecategorytotopsuccess'] = 'Successfully moved institution \'{$a->moved}\' to top level';
$string['movecategoriestotopsuccess'] = 'Successfully moved {$a->count} categories to top level';
$string['movecategoryto'] = 'Move institution to:';
$string['movecontentstoanothercategory'] = 'Move contents to another institution';
...
$string['moveselectedcoursesto'] = 'Move selected study groups to...';
...
$string['mycourses'] = 'My study groups';
...
$string['newcourse'] = 'New study group';
...
$string['nocourses'] = 'No study groups';
$string['nocoursesfound'] = 'No study groups were found with the words \'{$a}\'';
$string['nocoursesyet'] = 'No study groups in this category';
...
$string['nomorecourses'] = 'No more matching study groups could be found';
...
$string['novalidcourses'] = 'No valid study groups to be shown';
$string['now'] = 'now';
$string['numattempts'] = '{$a} failed login attempt(s)';
$string['numberofcourses'] = 'Number of study groups';
...
$string['parentcategory'] = 'Parent institution';
...
$string['recreatedcategory'] = 'Recreated institution {$a}';
...
$string['scalestandard_help'] = 'A standard scale is available site-wide, for all study groups.';
...
$string['searchcourses'] = 'Search study groups';
...
$string['showallcourses'] = 'Show all study groups';
$string['showallusers'] = 'Show all users';
$string['showblockcourse'] = 'Show list of study groups containing block';
...
$string['showingacourses'] = 'Showing all {$a} study groups';
$string['showingxofycourses'] = 'Showing study groups {$a->start} to {$a->end} of {$a->total} study groups';
$string['showlistofcourses'] = 'Show list of study groups';
$string['showmodulecourse'] = 'Show list of study groups containing activity';
...
$string['skiptocategorylisting'] = 'Skip to the institution listings';
...
$string['someallowguest'] = 'Some study groups may allow guest access';
...
$string['statsreport11'] = 'Most active study groups';
$string['statsreport12'] = 'Most active study groups (weighted)';
$string['statsreport13'] = 'Most participatory study groups (enrolments)';
$string['statsreport14'] = 'Most participatory study groups (views/posts)';
...
$string['subcategory'] = 'Subinstitution';
$string['subcategoryof'] = 'Subinstitution of {$a}';
...
$string['therearecourses'] = 'There are {$a} study groups';
$string['thiscategory'] = 'This institution';
$string['thiscategorycontains'] = 'This institution contains';
$string['time'] = 'Time';
...
$string['top'] = 'Top';
$string['toplevelcategory'] = 'Top level institution';
$string['topic'] = 'Topic';
...
$string['unknowncategory'] = 'Unknown institution';
...
$string['viewallcourses'] = 'View all study groups';
$string['viewallcoursescategories'] = 'View all study groups and categories';
...
$string['visible_help'] = 'This setting determines whether the course appears in the list of study groups. Apart from teachers and administrators, users are not allowed to enter the course.';
